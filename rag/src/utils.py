...
def load_hf(object_class, model_name, cache_dir=None):
    try:
        obj = object_class.from_pretrained(model_name, local_files_only=True, cache_dir=cache_dir)
    except:
        obj = object_class.from_pretrained(model_name, local_files_only=False, cache_dir=cache_dir)
    return obj
